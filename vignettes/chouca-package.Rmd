...
All the $(\beta_i)_{i \in [0:K]}$, $(a)_{i \in [1:K]}$, $(b)_{i \in [1:K]}$ 
...
probabilities cannot be accurately computed, so the best way to go is to write your 
model and see if it is supported.
