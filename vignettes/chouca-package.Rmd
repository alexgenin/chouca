...
<!-- 
```{r , echo = FALSE, output = TRUE, fig.show = "animate", fig.width = 4, fig.height = 4, dev='jpeg', interval = 0.04, cache = TRUE, eval = FALSE}
...
(NOTE: Please see animated version <a href="https://alex.lecairn.org/files/chouca_sca_gifcreate.webm">there</a>).
